...
$tiktok = new \NextpostTechAPI\TikTok($debug, $licenseKey);

try {
    $response = $tiktok->getNoWatermarkUrl($video_url, $proxy);
} catch (NextpostTechAPI\Exception\BadRequestException $e) {
...
} catch (NextpostTechAPI\Exception\ForbiddenException $e) {
